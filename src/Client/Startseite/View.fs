...
let root =
  [ Content.content []
      [ Notification.notification [ Notification.Color IsPrimary; Notification.Modifiers [ Modifier.TextAlignment (Screen.All, TextAlignment.Centered) ] ] [
        ...
        p [] [ str "Wir, Johannes und Sylvia, leben mit unseren zwei Kindern auf dem Enserhof im wunderschönen Ehrendorf bei Ohlsdorf - ca. 5 Autominuten von Gmunden entfernt." ]
        p [] [
